...
import (
	"giuhub.com/foxsugar-sanse/GO语言小Demo/stack"
	"unicode"
	"strconv"
	"fmt"
	"bufio"
...
func main() {
	...
	fmt.Printf("后缀表达式: ")
	for i := 0; i < len(postfix) && postfix[i] != ""; i++ {
...
func infix2ToPostfix(exp string) [100]string {
	stack := stack.ItemStack{}
	//postfix := ""
	...
	for !stack.IsEmpty() {
		//postfix += stack.Pop()
		postfix[indexArrayStrings] = stack.Pop()
		indexArrayStrings++
	}
